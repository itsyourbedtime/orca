...
local function add_params()
  ...
  params:set_action('import_p', function(x) 
    fileselect.enter(norns.state.data, orca.import) 
  end)
  ...
  params:add{ 
    ...
    action = function(value) 
      orca.midi_out_device = midi.connect(value) 
    end }
end
...
local function draw_bar()
  ...
  screen.move( 60, 63 )
  screen.text( string.sub( engines.engine_list[ params:get( "engine_name" ) ], 0, 5 ) )
  screen.stroke()
