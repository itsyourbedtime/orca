local param_ids = { "quality", "amp_env_sustain", "original_freq", "detune_cents", "by_percentage","filter_type","filter_freq", "filter_resonance", "pan"}
...
timber_param = function ( self, x, y, frame, grid )
  ...
  local value = ( param == 1 or param == 6) and val or param == 8 and ( val / #self.chars ) or param == 7 and val_scaled * 200 or val_scaled
